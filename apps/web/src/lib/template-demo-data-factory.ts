...
export const templateDemoFallbackWorkspace: OrbitWorkspaceSummary = {
  ...
  legalName: 'Orbit Demo Services Private Limited',
  ...
  addressLine1: 'Registered Office, Demo Business Park',
  addressLine2: 'Ellisbridge',
  city: 'Ahmedabad',
  postalCode: '380006',
  gstin: '24SAMPLE1234F1Z5',
  pan: 'SAMPL1234F',
  cin: 'U72900GJ2024PTC123456',
  registeredOfficeAddress: 'Registered Office, Demo Business Park, Ellisbridge, Ahmedabad, GJ 380006',
  principalPlaceOfBusiness: 'Demo Business Park, Ellisbridge, Ahmedabad',
  currency: 'INR',
  countryCode: 'IN',
  stateCode: 'GJ',
...
function withPreviewBrandFallbacks(workspace: OrbitWorkspaceSummary): OrbitWorkspaceSummary {
  return {
    ...
    addressLine1: workspace.addressLine1 ?? null,
    addressLine2: workspace.addressLine2 ?? null,
    city: workspace.city ?? null,
    town: workspace.town ?? null,
    ...
    gstin: workspace.gstin ?? null,
    pan: workspace.pan ?? null,
    ...
    entityType: workspace.entityType ?? null,
    entitySubtype: workspace.entitySubtype ?? null,
    entityVerificationStatus: workspace.entityVerificationStatus ?? null,
  };
}
