...
export const colors = {
  ...
  shell: brand.colors.shell,
  sidebar: brand.colors.sidebar,
  ...
  glassBorder: brand.colors.glassLine,
  ...
  focus: brand.colors.focus,
  selectedRow: brand.colors.selectedRow,
  tableStripe: brand.colors.tableStripe,
  topbarGlass: brand.colors.topbarGlass,
  backdrop: brand.colors.overlay,
};
