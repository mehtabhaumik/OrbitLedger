...
- Play Console app package name: `com.bhaumikmehta.orbitledger`
...
| --- | --- | --- | --- | --- | --- |
| Orbit Ledger Pro Monthly | `com.bhaumikmehta.orbitledger.pro.monthly` | Subscription | `monthly` | 1 month | `pro_monthly` |
| Orbit Ledger Pro Yearly | `com.bhaumikmehta.orbitledger.pro.yearly` | Subscription | `yearly` | 1 year | `pro_yearly` |

### One-Time Products

| Entitlement | Play product ID | Product type | App country code |
| --- | --- | --- | --- |
| United States Country Pack | `com.bhaumikmehta.orbitledger.countrypack.us` | One-time product | `US` |
| United Kingdom Country Pack | `com.bhaumikmehta.orbitledger.countrypack.uk` | One-time product | `GB` |
...
1. Create or open the Play Console app for package `com.bhaumikmehta.orbitledger`.
...
4. Create these subscription products:
   - Product ID: `com.bhaumikmehta.orbitledger.pro.monthly`
     - Name: Orbit Ledger Pro Monthly
     - Base plan ID: `monthly`
     - Billing period: Monthly
     - Status: Active
   - Product ID: `com.bhaumikmehta.orbitledger.pro.yearly`
...
6. Create these one-time products:
   - Product ID: `com.bhaumikmehta.orbitledger.countrypack.us`
     - Name: United States Country Pack
     - Status: Active
   - Product ID: `com.bhaumikmehta.orbitledger.countrypack.uk`
     - Name: United Kingdom Country Pack
     - Status: Active
7. Do not create `com.bhaumikmehta.orbitledger.countrypack.in`.
...
4. Confirm the installed app package is `com.bhaumikmehta.orbitledger`.
...
- Android package is `com.bhaumikmehta.orbitledger`.
