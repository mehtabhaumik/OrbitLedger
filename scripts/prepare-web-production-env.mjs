...
const defaultProductionSiteUrl = 'https://orbitledger.rudraix.com';
const productionSiteUrl =
  process.env.NEXT_PUBLIC_ORBIT_LEDGER_SITE_URL?.trim() ||
  process.env.ORBIT_LEDGER_SITE_URL?.trim() ||
...
const env = [
  ...
  `NEXT_PUBLIC_ORBIT_LEDGER_SITE_URL=${productionSiteUrl}`,
